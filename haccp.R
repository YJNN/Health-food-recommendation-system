...
##########API를 통해 받아온 건강기능제품 데이터셋
healthInf <- read.csv("건강.csv", header=T)
...
names(healthInf_subset)
View(healthInf_subset)
...
##########각 제품에 대한 쉼표로 구분되어 있는 구성요소들을 열 별로 나눔.
